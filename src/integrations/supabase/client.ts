...
// IMPORTANTE: VITE_EXTERNAL_SUPABASE_URL tem prioridade sobre VITE_SUPABASE_URL
// porque o Lovable Cloud injeta VITE_SUPABASE_URL automaticamente apontando para
// o projeto interno (vpkmqeumtxhrwgawxdrl) — não é o destino desejado.
